...
export const investorSchema = z.object({
   investmentSize: z.enum(["Under-50k", "50k-100k", "100k-500k", "500k-1m", "1m-plus"]),
   preferredStages: z.array(z.enum(["Bootstrapped", "Pre-seed", "Seed", "Series A", "Series B", "Series C+", "Acquired"])),
...
export const supporterSchema = z.object({
   ...
   availability: z.enum(["One Off", "Ongoing", "Project Based"]),

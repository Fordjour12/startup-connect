    ...
    <form method="POST" use:enhance class="space-y-8">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Details about your funding status</CardDescription
                >
            </CardHeader>
            <CardContent class="space-y-4">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Your startup's performance metrics</CardDescription
                >
            </CardHeader>
            <CardContent class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Identify your main competitors and your competitive
                    advantage</CardDescription
                >
            </CardHeader>
            <CardContent>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription
                    >Choose whether to publish your startup immediately or save
                    as draft</CardDescription
                >
            </CardHeader>
            <CardContent>
                    ...
                    <Form.Control>
                        {#snippet children({ props })}
                            ...
                            <p class="text-sm text-muted-foreground mt-2">
                                ...
                                {:else}
                                    Your startup will be saved as a draft and

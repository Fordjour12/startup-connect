      ...
      <div class="max-w-6xl mx-auto px-4 py-2">
         ...
         <div class="mb-3">
            ...
            <div class="space-y-2">
               ...
               <Progress value={onboarding.progressPercentage} class="h-2" />
            </div>
         </div>
         ...
         <div class="flex flex-wrap gap-2">
            {#each onboarding.availableSteps as step, index}
               <button
                  ...
                  disabled={!onboarding.canNavigateToStep(step) || isLoading}
   ...
   <main class="max-w-6xl mx-auto px-4 py-8">
            ...
            {#if onboarding.currentStep !== "completion"}
               <div class="flex items-center justify-between pt-8 border-t">
                  ...
                  <div class="flex items-center gap-3">
                     ...
                     >
                        <Save class="w-4 h-4" />
                        {onboarding.isSaving ? "Saving..." : "Save Progress"}
                     </Button>

                     <!-- Next/Submit Button -->
                     {#if onboarding.currentStep === "review"}
                        <Button
                           onclick={() => onboarding.submitOnboarding()}
                     ...
                     {:else}
                        <Button
                           onclick={handleNext}
                           disabled={!onboarding.canGoForward || isLoading}
                           class="flex items-center gap-2"
                        >
                           Continue
      ...
      <div class="mt-8 text-center">
         <p class="text-sm text-muted-foreground">
            ...
            >
            or check out our
            <a href="/help" class="text-primary hover:underline">help center</a
            >.
         </p>

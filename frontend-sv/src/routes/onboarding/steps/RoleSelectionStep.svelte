<script lang="ts">
   ...
   let selectedRole = $state<UserRole | null>(onboarding.formData.role || null);
...
<div class="space-y-8">
            ...
            <CardHeader>
               <div class="flex items-start justify-between mb-4">
                  ...
                  {#if selectedRole === role.id}
                     <CheckCircle2 class="size-6 text-primary flex-shrink-0" />
                  {/if}
               </div>
            </CardHeader>
            ...
            <div class="flex items-start gap-4">
               ...
               <div class="flex-1">
                  ...
                  <p class="text-muted-foreground text-sm mb-4 font-body">
                     We'll customize your experience based on your role as a {selectedRoleData.title.toLowerCase()}.
                     Next, we'll ask for some {selectedRoleData.title.toLowerCase()}-specific
   ...
   <!-- Action Buttons    <div class="flex justify-center pt-6">
      <Button
         onclick={handleContinue}
         disabled={!selectedRole}
         size="lg"
         class="px-8 py-3 bg-primary hover:bg-primary/90 text-primary-foreground"
      >
         {selectedRole ? "Continue Setup" : "Select a Role to Continue"}
      </Button>
   </div>  -->

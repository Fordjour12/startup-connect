<script lang="ts">
   ...
   $effect(() => {
      ...
      if (formData.specificNeeds.length === 0) {
         newErrors.specificNeeds = "Please select at least one specific need";
      }
...
<div class="space-y-8">
   ...
   <Card>
      <CardHeader>
         ...
         <p class="text-sm text-gray-600">
            What do you personally hope to achieve? (Optional but recommended)
         </p>
      </CardHeader>
      <CardContent class="space-y-4">
         ...
         {#if formData.personalGoals.length > 0}
            <div class="space-y-2">
               <Label class="text-sm font-medium">Your personal goals:</Label>
               <div class="flex flex-wrap gap-2">
   ...
   <Card>
      ...
      <CardContent class="space-y-4">
         ...
         {#if currentRole && suggestedPlatformGoals[currentRole]}
            <div class="space-y-3">
               <Label class="text-sm font-medium">Common platform goals:</Label>
               <div class="flex flex-wrap gap-2">
         ...
         {#if formData.platformGoals.length > 0}
            <div class="space-y-2">
               <Label class="text-sm font-medium">Your platform goals:</Label>
               <div class="flex flex-wrap gap-2">
   ...
   <Card>
      <CardHeader>
         ...
         <p class="text-sm text-gray-600">
            What specific help or support are you looking for? (Select multiple)
         </p>
      </CardHeader>
      <CardContent class="space-y-4">
         <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            {#each (currentRole && specificNeedsOptions[currentRole]) || [] as need}
               ...
               >
                  ...
                  />
                  <Label class="text-sm cursor-pointer flex-1">{need}</Label>
               </div>
            {/each}
         </div>

<script lang="ts">
   import AddInvestmentForm from "@/components/investor/AddInvestmentForm.svelte";
               ...
               <Card>
                  ...
                  >
                     <div>
                        ...
                        <CardDescription>
                           Track all your startup investments and their current
                           performance
                        </CardDescription>
                     </div>
                     <AddInvestmentForm />
                           ...
                           <TableBody>
                              {#each investments as investment}
                                 <TableRow>
                                    ...
                                    >
                                    <TableCell
                                       class={getROIClass(investment.roi)}
                                    >
            ...
            <TabsContent value="documents">
               <Card>
                  <CardHeader>
                     ...
                     <CardDescription>
                        Store and organize important documents related to your
                        investments
                     </CardDescription>
                  </CardHeader>
                  <CardContent>
               ...
               <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <Card class="lg:col-span-2">
                     <CardHeader>
                        ...
                        <CardDescription>
                           Compare initial investments to current valuations
                        </CardDescription>
                     </CardHeader>
                     <CardContent>
                        <!-- <Chart
                     ...
                     <CardContent>
                        <div class="space-y-6">
                           <div>
                              <div class="flex justify-between mb-1">
                                 <span class="text-sm font-medium"
                                    >Overall ROI</span
                                 >
                                 <span class={getROIClass(metrics.overallROI)}
                                    >{formatPercentage(
                                       metrics.overallROI,
                                    )}</span
                                 >
                           ...
                           <div>
                              ...
                              <Progress
                                 value={metrics.averageAnnualReturn > 0
                                    ? metrics.averageAnnualReturn
                                    : 0}
                                 max={50}
                              />
                           ...
                           <div>
                              ...
                              <Progress
                                 value={metrics.benchmarkComparison + 10}
                                 max={20}
                              />
                           </div>
                        </div>
               ...
               <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Card>
                     <CardHeader>
                        ...
                        <CardDescription>
                           Plan and visualize potential exit scenarios for your
                           investments
                        </CardDescription>
                     </CardHeader>
                     <CardContent>
                              ...
                              >
                                 ...
                                 <div class="grid grid-cols-2 gap-4 mb-2">
                                    <div>
                                       ...
                                       <p class="font-medium">
                                          {formatCurrency(exit.potentialValue)}
                                       </p>
                                    </div>
                                    <div>
                                       <p class="text-sm text-muted-foreground">
                                       ...
                                       <p class="font-medium text-emerald-500">
                                          {formatPercentage(exit.expectedROI)}
                                       </p>
                                    </div>
                                    <div>
                                       <p class="text-sm text-muted-foreground">
                  ...
                  <Card>
                     <CardHeader>
                        ...
                        <CardDescription>
                           Model different exit scenarios and their financial
                           impact
                        </CardDescription>
                     </CardHeader>
                     <CardContent>
               ...
               <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card>
                     <CardHeader>
                        ...
                        <CardDescription>
                           Portfolio allocation across different sectors
                        </CardDescription>
                     </CardHeader>
                     <CardContent>
                        <!-- <Chart

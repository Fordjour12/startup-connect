...
<div class="container py-8 max-w-screen-2xl">
    <div class="flex flex-col gap-8">
        <!-- Page Header -->
        <div>
            <h1 class="text-3xl font-bold tracking-tight">Startup Discovery</h1>
            <p class="text-muted-foreground mt-2">
                Find your next investment opportunity with our powerful search
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex gap-2">
                <Button
                    variant="outline"
                    class="flex gap-2 items-center h-12"
        ...
        <Tabs.Root value="all" class="space-y-6">
            <Tabs.List class="grid grid-cols-4 w-full max-w-2xl">
                <Tabs.Trigger
                    value="all"
            ...
            <Tabs.Content value="recommended" class="space-y-6">
                ...
                <p class="text-muted-foreground">
                    Based on your investment history and preferences, we think
                    these startups might interest you.
                </p>
            ...
            <Tabs.Content value="trending" class="space-y-6">
                ...
                <p class="text-muted-foreground">
                    Startups gaining momentum in their sectors based on recent
                    growth, funding, and market attention.
                </p>
            ...
            <Tabs.Content value="featured" class="space-y-6">
                ...
                <p class="text-muted-foreground">
                    High-potential startups curated by our investment experts.
                </p>
...
<Sheet.Root bind:open={filtersOpen}>
    <Sheet.Content side="right" class="w-full sm:max-w-md">
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2">
                    {#each industries as industry}
                        <Badge
                            variant={selectedIndustries.includes(industry.value)
                                ? "default"
                                : "outline"}
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2">
                    {#each locations as location}
                        <Badge
                            variant={selectedLocations.includes(location.value)
                                ? "default"
                                : "outline"}
                            class="cursor-pointer"
                            onclick={() => {
        ...
        <Sheet.Footer>
            <div class="flex gap-2">
                <Button variant="outline" onclick={resetFilters} class="flex-1"
                    >Reset</Button
                >
...
<Dialog.Root bind:open={saveSearchOpen}>
    <Dialog.Content>
        ...
        <Dialog.Footer>
            <Button variant="outline" onclick={() => (saveSearchOpen = false)}
                >Cancel</Button
            >

...
<div class="container mx-auto px-4 py-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select type="single" bind:value={reportSchedule}>
                                    <SelectTrigger>
                                        Select schedule
                                    </SelectTrigger>
                                    <SelectContent>
                                ...
                                <Button
                                    ...
                                    onclick={() =>
                                        (showAdvancedFilters =
                                            !showAdvancedFilters)}
                                >
                                    {showAdvancedFilters ? IconEyeOff : IconEye}
                        ...
                        <div class="space-y-2">
                            ...
                            <Select type="single" bind:value={dateRange}>
                                <SelectTrigger>Select date range</SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="7"
                    ...
                    {#each mockReports as report}
                        ...
                        >
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                >
                                    <IconFileSpreadsheet class="h-4 w-4 mr-1" />
                                    Export
                                </Button>
                    ...
                    {#if scheduleEnabled}
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                <Select type='single' bind:value={scheduleFrequency}>
                                    <SelectTrigger>
                                        Select frequency
                                    </SelectTrigger>
                                    <SelectContent>
    ...
    <Dialog bind:open={showExportDialog}>
        <DialogContent class="max-w-md">
            <DialogHeader>
                <DialogTitle class="flex items-center space-x-2">
                    <IconDownload class="h-5 w-5 text-green-500" />

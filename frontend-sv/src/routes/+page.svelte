            ...
            <div class="text-center lg:text-left">
               <div class="space-y-8 max-w-2xl mx-auto lg:mx-0">
                  ...
                  >
                     ...
                     fundraising, and accelerate your startup's growth with our
                     AI-powered platform.
                  </p>
                  ...
                  >
                     ...
                     >
                        <div class="flex items-center gap-3">
                           ...
                           >
                              <TrendingUpIcon class="h-5 w-5 text-success" />
                           </div>
                           <div>
      ...
      <div class="container mx-auto px-4 sm:px-6">
         <div class="text-center mb-16">
            ...
            <p class="text-lg text-muted-foreground max-w-3xl mx-auto">
               The journey from innovation to successful business requires the
               right partnerships. We've built the bridge between visionary
            ...
            <div class="space-y-8 order-2 md:order-1">
               ...
               >
                  ...
                  <div>
                     ...
                     <p class="text-muted-foreground mb-3">
                        Get connected with investors who understand your vision
                        and can provide more than just capital.
                     </p>
               ...
               >
                  ...
                  <div>
                     ...
                     <p class="text-muted-foreground mb-3">
                        Access pre-vetted opportunities aligned with your
                     ...
                     <div class="space-y-6">
                        <div class="relative pl-8">
                           ...
                           <div class="mb-1 flex justify-between">
                              <span class="font-medium">Matching Accuracy</span>
      ...
      <div class="container mx-auto px-4 sm:px-6">
         ...
         <div class="text-center mb-16">
            ...
            <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
               Connect with innovative startups actively seeking investment and
   ...
   <section id="features" class="py-20 lg:py-28">
      <div class="container mx-auto px-4 sm:px-6">
         ...
         <div class="text-center mb-16">
            ...
            <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
               Everything you need to streamline your fundraising journey and
               ...
               <div class="group">
                  ...
                  >
                     ...
                     <Card.Header class="">
                        ...
                        <div>
                           <Card.Title class="text-xl font-semibold mb-2"
      ...
      <div class="container mx-auto px-4 sm:px-6 relative">
         <div class="max-w-3xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
               <Button
                  class="bg-destructive hover:bg-muted-foreground rounded-full h-12 px-8"
               >
                  Get Started Free

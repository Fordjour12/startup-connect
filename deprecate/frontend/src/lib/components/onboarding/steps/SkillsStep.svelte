<script lang="ts">
    ...
    import { skillsSchema, type Skills } from "@/schemas/onboarding-schema";
    ...
    $effect(() => {
        ...
        formData = {
            skills: (onboardingState.formData.skills as Skills["skills"]) || [],
            experienceLevel:
                (onboardingState.formData
                    .experienceLevel as Skills["experienceLevel"]) ||
                ("" as Skills["experienceLevel"]),
            industries:
                (onboardingState.formData.industries as Skills["industries"]) ||
                [],
            achievements: onboardingState.formData.achievements || "",
            expertiseAreas: onboardingState.formData.expertiseAreas || "",
            certifications: onboardingState.formData.certifications || "",
        };

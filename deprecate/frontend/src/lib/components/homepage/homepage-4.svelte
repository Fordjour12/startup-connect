<script lang="ts">
    ...
    const featuredStartups = [
        ...
        },
        {
            ...
            stage: "Series B",
            description:
                "Enterprise data analytics platform leveraging ML for actionable business insights.",
            seeking: "$8M",
...
<div
    class="min-h-screen flex flex-col bg-background text-foreground antialiased overflow-x-hidden"
>
    <Header />
                    ...
                    <div class="group">
                        ...
                        >
                            <Card.Header class="flex items-start gap-4 p-6">
                                <div
                                    class={`w-12 h-12 rounded-lg flex items-center justify-center ${feature.color} transition-transform group-hover:scale-110`}
                                >
                    ...
                    <div class="transition-all duration-500 animate-fadeIn">
                        <Card.Root class="bg-card border border-border/50">
                            <Card.Content class="p-8">
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute -top-4 -left-4 h-8 w-8 text-primary/10"
                                        >"</span
                                    >
                                    <blockquote
                                        class="text-lg text-muted-foreground italic mb-6 pt-4 px-4"
                                    >
                                        "{testimonial.quote}"
                                    </blockquote>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    {#each Object.entries(testimonial.metrics) as [key, value]}
                                        <div
                                            class="p-3 rounded-lg bg-primary/5"
                                        >
                                            <div

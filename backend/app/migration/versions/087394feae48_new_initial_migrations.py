...
Revision ID: 087394feae48
Revises:
Create Date: 2025-05-28 21:01:20.166254
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('FOUNDER', 'SUPPORTER', 'INVESTOR', name='userrole'), nullable=False),
    ...
    sa.Column('industry', sa.Enum('TECHNOLOGY', 'HEALTHCARE', 'FINANCE', 'EDUCATION', 'RETAIL', 'MANUFACTURING', 'REAL_ESTATE', 'ENERGY', 'TRANSPORTATION', 'MEDIA', 'ENTERTAINMENT', 'FOOD_BEVERAGE', 'AGRICULTURE', 'HOSPITALITY', 'CONSTRUCTION', 'TELECOMMUNICATIONS', 'BIOTECHNOLOGY', 'AEROSPACE', 'AUTOMOTIVE', 'ECOMMERCE', 'GAMING', 'CYBERSECURITY', 'FINTECH', 'HEALTH_TECH', 'ED_TECH', 'OTHER', name='industry'), nullable=False),
    sa.Column('location', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('funding_stage', sa.Enum('IDEA', 'MVP', 'EARLY_STAGE', 'PRE_SEED', 'SEED', 'SERIES_A', 'SERIES_B', 'SERIES_C', 'IPO', 'MERGER_ACQUISITION', 'OTHER', name='fundingstage'), nullable=False),

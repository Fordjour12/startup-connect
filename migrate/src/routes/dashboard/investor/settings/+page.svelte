				...
				<nav class="flex flex-col space-y-1 w-full">
					...
					>
						<Avatar class="h-4 w-4 mr-2">
							...
							/>
							<AvatarFallback
								>{profile.firstName[0]}</AvatarFallback
							>
						</Avatar>
						Profile
					</button>
						...
						<div class="space-y-6">
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
								...
								<div class="space-y-6">
									...
									<div class="space-y-2">
										<Label for="check-size"
											>Typical Check Size</Label
										>
										<Input
											id="check-size"
											bind:value={
												editingProfile.typicalCheckSize
											}
								...
								>
									...
									>
										<div class="space-y-0.5">
											...
											>
												Receive a daily summary of your
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Get updates from your portfolio
												companies
											</p>
										</div>
										<Switch
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Be notified when companies open
												new funding rounds
											</p>
										</div>
										<Switch
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Receive industry news and market
												trends
											</p>
										</div>
										<Switch
									...
									>
										<div class="space-y-0.5">
											...
											>
												...
												from founders and team members
											</p>
										</div>
										<Switch
											id="email-messages"
											checked={notificationPreferences
												.email.messageNotifications}
											onCheckedChange={(checked) =>
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Show alerts for new investment
												opportunities
											</p>
										</div>
										<Switch
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Show alerts for significant
												portfolio metric changes
											</p>
										</div>
										<Switch
											id="app-portfolio-metrics"
											checked={notificationPreferences
												.inApp.portfolioMetricAlerts}
											onCheckedChange={(checked) =>
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Show notifications for upcoming
												events
											</p>
										</div>
										<Switch
								...
								>
									...
									>
										<div>
											...
											>
												For security, it's recommended
												to change your password every 3
												months
											</p>
										</div>
								...
								>
									<table class="w-full text-sm">
										<thead>
											<tr class="border-b">
												<th
													class="text-left font-medium py-2 px-2"
													>Date</th
												>
												<th
													class="text-left font-medium py-2 px-2"
						...
						<div class="space-y-8">
							...
							<div class="space-y-4">
								...
								>
									<div class="space-y-2">
										<Label
											>Share your investment history</Label
										>
										<div
								...
								>
									...
									<div class="space-y-2">
										...
										<p
											class="text-xs text-muted-foreground mt-1"
										>
											How long we retain your activity
								...
								>
									...
									>
										...
										<Switch
											...
											onCheckedChange={(checked) =>
												(appearanceSettings.compactCards =
													checked)}
										/>
									</div>
								</div>
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Minimize animations throughout
												the interface
											</p>
										</div>
										<Switch
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Allow external applications to
									...
									{#if apiAccess.enabled}
										...
										<div class="flex flex-col space-y-2">
											...
											<p
												class="text-xs text-muted-foreground"
											>
												Warning: Regenerating your API
												key will invalidate any existing
												integrations
											</p>
										</div>
									{/if}
										...
										<div class="space-y-4">
											<div>
												...
												<p
													class="text-xs text-muted-foreground mt-1"
												>
													Plan resets on {apiAccess
														.usage.resetDate}
												</p>
											</div>

											<div
												class="bg-card/50 p-4 rounded-md"
											>
												<h4
								...
								<div class="space-y-4">
									...
									>
										<p class="text-sm">
											...
											documentation to integrate with our
											platform.
										</p>
					...
					{:else if activeTab === "integrations"}
						...
						<div class="space-y-8">
							...
							<div class="space-y-4">
								...
								<div
									class="space-y-6 bg-secondary/10 p-4 rounded-md"
								>
							...
							<div class="space-y-4">
								...
								>
									...
									>
										<div class="space-y-0.5">
											...
											<p
												class="text-sm text-muted-foreground"
											>
												Automatically sync data between
												connected services
											</p>
										</div>
										<Switch
											id="auto-sync"
											checked={integrations.syncSettings
												.autoSync}
											onCheckedChange={(checked) =>
									...
									<div class="pt-2">
										...
										>
											Last synchronized: {integrations
